export class RetrocesoScannerCrypto {
    ...
    EvaluaterBar(bar) {
        ...
        if (this.setupActivo) {
            ...
            this.ValidationCrown(this.fib95_, this.fib60_, this.fib35_, bar);
        ...
        if (!this.setupActivo && bullBreak && alcistaPermitido) {
            ...
            if (!this.crown) {
                this.crown = (bar.close < this.fib60_);
            }
            this.obEncontrado_ = false;
            this.obTop_ = null;
            this.obBottom_ = null;
    ...
    ValidationCrown(sl, pe, tp, lastBar) {
        ...
        if (orientationUp) {
            ...
            if (this.crown && (lastBar.close < tp || lastBar.close > sl)) {
                this.crown = false;
                this.setupActivo = false;
                this.clean();
            }
